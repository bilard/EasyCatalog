...
const FunctionList: React.FC<FunctionListProps> = ({ functions, selectedFunction, onSelectFunction, searchTerm, onSearchChange, onInsertFunction, paramValues, onParamChange }) => {
  ...
  return (
    <div className="bg-slate-800/50 border border-slate-700 rounded-xl shadow-lg backdrop-blur-sm flex h-[65vh]">
      ...
      <div className="w-2/3 p-6 md:p-8 overflow-y-auto flex flex-col">
        {selectedFunction ? (
          <>
